...
- **Knowledge Base**: Healthcare workforce policies, procedures, and best practices
- **Fallback**: Built-in knowledge base when ChromaDB is unavailable
...
2. **Add knowledge to the database:**
```bash
# Initialize with sample healthcare data
python rasa/scripts/add_knowledge.py --init-sample

# Add custom documents
python rasa/scripts/add_knowledge.py --add-text "Your policy text here" --category policies
```
...
4. Test chat functionality with RAG-enhanced responses
