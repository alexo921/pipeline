        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full">
            <div className="p-6 sm:p-8">
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">Step 1 of 3 - Basic Information</p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                {...register('name')}
                                className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:border-transparent transition-all outline-none text-sm ${errors.name ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                                    }`}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="email"
                                {...register('email')}
                                className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:border-transparent transition-all outline-none text-sm ${errors.email ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                                    }`}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:border-transparent transition-all outline-none text-sm appearance-none bg-white ${errors.healthcareRole ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                                    }`}
                                disabled={isSubmitting}
                            >
                        ...
                        {errors.healthcareRole && <p className="mt-1 text-sm text-red-600">{errors.healthcareRole.message}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:border-transparent transition-all outline-none text-sm appearance-none bg-white ${errors.certificationStatus ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                                    }`}
                                disabled={isSubmitting}
                            >
                        ...
                        {errors.certificationStatus && <p className="mt-1 text-sm text-red-600">{errors.certificationStatus.message}</p>}
                    </div>
