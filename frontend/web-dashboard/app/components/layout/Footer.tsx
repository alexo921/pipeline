...
const Footer = () => {
  ...
  const isDefault = company.id === 'default';
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="block lg:hidden">
          <div className="flex flex-col items-center text-center space-y-8">
                ...
                {isDefault ? (
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    {company.isPoweredByPipeline && (
                      <span className="text-xs text-gray-400">Powered by Pipeline</span>
                    )}
                  </div>
                )}
              </div>
            ...
            {/* Social Media Icons — only shown for Pipeline default */}
            {isDefault && (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-8 sm:mt-12 lg:mt-16 pt-6 sm:pt-8 space-y-4 sm:space-y-0">
          <div className="text-sm sm:text-base lg:text-[18px] font-normal leading-[167%] text-[#01253F] font-avenir text-center sm:text-left">
            {isDefault
              ...
              : `© 2025 ${company.name} | Powered by Pipeline Workforce, Inc.`}
          </div>
