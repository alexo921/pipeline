        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto">
            <div className="p-6 sm:p-8">
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">Step 2 of 3 - Location Information</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
                    {/* ZIP Code */}
                    <div>
                        <label htmlFor="signup-zipcode" className="block text-sm font-medium text-gray-700 mb-1">
                            ZIP Code
                        </label>
                    ...
                    {/* Max Travel Distance */}
                    <div>
                        <label htmlFor="signup-travel" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        {errors.maxTravelDistance && <p className="mt-1 text-sm text-red-600">{errors.maxTravelDistance.message}</p>}
                        <p className="mt-1 text-xs text-gray-500">How far are you willing to travel for work?</p>
                    </div>
