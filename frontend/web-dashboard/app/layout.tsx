  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" type="image/png" href="/pipeline_logo_p.png?v=4" />
        <link rel="shortcut icon" href="/favicon.svg?v=4" />
        <link rel="apple-touch-icon" href="/pipeline_logo_p.png?v=4" />
        <meta name="msapplication-TileImage" content="/pipeline_logo_p.png?v=4" />
      </head>
