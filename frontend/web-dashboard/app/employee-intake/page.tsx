...
import { User, Mail, Phone, MapPin, Briefcase, Clock, DollarSign, FileText, Send } from 'lucide-react';
...
export default function EmployeeIntakePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/intake-forms/employee', {
        method: 'POST',
        headers: {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2466D0] focus:border-transparent font-avenir"
                      placeholder="e.g., $20-25/hour or $45,000-55,000/year"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl lg:rounded-[20px] shadow-[4px_3px_12px_rgba(36,102,208,0.4)] p-6 lg:p-8">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2466D0] focus:border-transparent font-avenir"
                    placeholder="Any additional information about your experience, preferences, or what you're looking for in a job..."
                  />
                </div>
              </div>
              ...
              {submitStatus === 'success' && (
                <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg text-center font-avenir">
                  Thank you! Your intake form has been submitted successfully. We'll be in touch soon with job opportunities.
                </div>
              )}
